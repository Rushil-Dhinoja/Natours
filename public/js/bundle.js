      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Account Created Succesfully');
              location.assign('/');
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicnVzaGlsLWRoaW5vamEiLCJhIjoiY2s4dTd1cHM2MDhhajNucGFvdXpoMjkxMiJ9.GnLqy_Er_tIjAG7S16syAw';
...
var stripe = Stripe('pk_test_ZS6iSWFXbA3kkw3xa0dRs9GK00sHqdz18a');
